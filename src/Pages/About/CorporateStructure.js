            ...
            <div id="corporate-structure" className=" about-wrapper-7 ">
                <div className="container mx-auto px-4">
                    <div className="py-36">
                        ...
                        {/*  Desktop view */}
                        {/* ------------------------------------------ */}
                        <div style={{height : '690px'}} className="hidden xl:block charts p-8 bg-blue-aqua rounded-xl text-sm">
                            ...
                            <div className="flex">
                                ...
                                <div className="relative w-1/4 ">
                                   ...
                                   {/* Lines horizontal */}
                                   <div style={{left : 0, top : '120px'}}  className="absolute  w-full h-1 bg-blue-lazur"></div>
                                   <div style={{left : 0, top : '230px'}}  className="absolute  w-full h-1 bg-blue-lazur"></div>
                                   <div style={{left : 0, top : '360px'}}  className="absolute  w-full h-1 bg-blue-lazur"></div>
                                   <div style={{left : 0, top : '460px'}}  className="absolute  w-full h-1 bg-blue-lazur"></div>
                                   {/* Lines */}
                                    <div style={{height : '460px', left : '0', top : '0px'}} className="absolute  w-1  bg-blue-lazur "></div>
                                    ...
                                    {/* block 5 */}
                                    <div style={{right : 0, top : '90px', width : '260px'}} className="p-5 bg-dark-blue-grad w-fit rounded-xl text-white absolute  ">
                                        Կապիտալ շուկաների բաժին
                                    </div>
                                    <div style={{right : 0, top : '190px', width : '260px'}} className="p-5 bg-dark-blue-grad w-fit rounded-xl text-white absolute  ">
                                    Ակտիվների կառավարման և արժեթղթերով գործառնությունների բաժին
                                    </div>
                                    <div style={{right : 0, top : '330px', width : '260px'}} className="p-5 bg-dark-blue-grad w-fit rounded-xl text-white absolute  ">
                                    Իրավաբանական բաժին
                                    </div>
                            ...
                            <div className="flex">
                                <div className="relative w-1/4 ">
                                    {/* Line */}
                                    <div style={{height : '100px', left : '70px', top : '200px'}} className="absolute  w-1 bg-dark-blue-2 "></div>
                                    <div style={{height : '150px', left : '140px', top : '300px'}} className="absolute  w-1 bg-dark-blue-2 "></div>
                                    <div style={{ left : '140px', top : '380px', width : '400px'}} className="absolute  h-1 bg-dark-blue-2 "></div>
                                    <div style={{height : '100px', left : '540px', top : '380px'}} className="absolute  w-1 bg-dark-blue-2 "></div>
                                    
                                    {/* Block */}
                                    <div style={{ left: 0, top: '150px' }} className="p-5 bg-dark-blue w-fit  border-dark-blue border-2 rounded-xl text-white absolute ">
                                        Dimension CJSC
                                        <div className="text-xs">28.09.2018</div>
                                    </div>
                                    <div style={{ left: 0, top: '280px', width : '330px' }} className="p-5 bg-dark-blue border-dark-blue border-2 w-fit rounded-xl text-white absolute ">
                                        Դայմենշն Ֆանդզ Մենեջմենթ ՍՊԸ 
                                        <div className="text-xs">31.01.2020</div>
                                    </div>
                                    <div style={{ left: 0, top: '420px', width : '330px' }} className="p-5 bg-dark-blue border-dark-blue border-2 w-fit rounded-xl text-white absolute ">
                                        Դայմենշն Ֆիքսդ Ինքամ Ֆոնդ
                                        <div className="text-xs">31.01.2020</div>
                                    </div>
                                    <div style={{ left: '380px', top: '420px', width : '350px' }} className="p-5 bg-dark-blue border-dark-blue border-2 w-fit rounded-xl text-white absolute ">
                        ...
                        <div style={{height : '1300px'}} className="block xl:hidden charts p-8 bg-blue-aqua rounded-xl text-xs">
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="relative w-full h-24">
                                    ...
                                    {/* block 2 */}
                                    <div style={{left : 0, top : '-30px', width : '130px'}} className="flex absolute  w-full ">
